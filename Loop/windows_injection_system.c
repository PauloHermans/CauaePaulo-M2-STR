...
static void tp_injecao_eletronica(void *pvParameter)
{
    ...
    TickType_t delayTicks = DELAY_MICROSECONDS / (1000000 / portTICK_PERIOD_MS);
    TickType_t delayTicksMicro = (TickType_t)((DELAY_MICROSECONDS * portTICK_PERIOD_MS) / 1000);
    ...
    while (1) {
        ...
        if (touch_value < TOUCH_THRESHOLD) {
            ...
            // Esperar DELAY_MICROSECONDS microsegundos antes da próxima verificação
            vTaskDelay(delayTicksMicro / portTICK_PERIOD_MS);
...
#endif
    // Iniciar a tarefa para verificar o touch
