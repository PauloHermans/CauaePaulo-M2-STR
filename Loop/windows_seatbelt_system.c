...
// Variável para monitorar se o touch foi ativado
...
static void tp_seatbelt(void *pvParameter)
{
    ...
    TickType_t readDelay = RESPONSE_TIME_MS / portTICK_PERIOD_MS;
...
{
    TickType_t xLastWakeTime = xTaskGetTickCount();
    TickType_t checkInterval = SEATBELT_CHECK_INTERVAL_MS / portTICK_PERIOD_MS;
    ...
    while (1) {
        ...
        vTaskDelayUntil(&xLastWakeTime, checkInterval);
