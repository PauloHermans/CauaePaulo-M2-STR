...
void app_main() {
    ...
    xTaskCreate(monitoramento_airbag, "monitoramento_airbag", 2048, NULL, 6, NULL);
    xTaskCreate(monitoramento_abs, "monitoramento_abs", 2048, NULL, 5, NULL);
    xTaskCreate(monitoramento_injecao, "monitoramento_injecao", 2048, NULL, 4, NULL);
    xTaskCreate(monitoramento_temperatura, "monitoramento_temperatura", 2048, NULL, 3, NULL);
